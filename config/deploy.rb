...
set :scm,             :git
set :repository,      "git@github.com:fotoetienne/lmsn2.git"
set :branch,          "origin/master"
set :migrate_target,  :current
set :ssh_options,     { :forward_agent => true }
set :rails_env,       "production"
set :deploy_to,       "/var/www/letmesingnow.com"
...
namespace :deploy do
  ...
  task :restart, :except => { :no_release => true } do
    run "kill -s USR2 `cat /tmp/unicorn.lmsn.pid`"
  end
  ...
  task :stop, :except => { :no_release => true } do
    run "kill -s QUIT `cat /tmp/unicorn.lmsn.pid`"
  end  
